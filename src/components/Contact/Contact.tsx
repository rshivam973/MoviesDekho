...
const EMAILJS_TEMPLATE_ID = process.env.REACT_APP_TEMPLATE_ID as string;
const EMAILJS_USER_ID = process.env.REACT_APP_PUBLIC_KEY as string;
const EMAILJS_SERVICE_ID = process.env.REACT_APP_SERVICE_ID as string;
