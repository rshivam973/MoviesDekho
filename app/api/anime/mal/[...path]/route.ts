...
export async function GET(
    ...
    const MAL_BASE_URL = process.env.NEXT_PUBLIC_MYANIMELIST_BASE_URL || 'https://api.myanimelist.net/v2';
    const MAL_CLIENT_ID = process.env.NEXT_PUBLIC_MYANIMELIST_CLIENT_ID;
